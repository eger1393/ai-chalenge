...
- Retrieval может использовать компактный hint от стратегии контекста только для снятия неоднозначности поиска, но не как источник доказательств в ответе
